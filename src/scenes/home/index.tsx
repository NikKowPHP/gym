...
export function Home({ setSelectedPage }: Props) {
	const isAboveMediumScreens = useMediaQuery("(min-width: 1060px)");
	return (
		<section id="home" className="gap-16 bg-gray pb-10 py-10 md:h-full md:pb-0">
				...
				<div className="z-10 mt-32 md:basis-3/5">
					...
					>
						...
						<p className="mt-8 text-sm">
							...
							eos neque distinctio, odio officiis corrupti quis.
						</p>
					</motion.div>
					{/* ACTIONS */}
					<motion.div
